...
- **Security starfield.** ~230 floating security icons drift and twinkle like stars (Trinity-style). Icons render behind the name with a center radial mask so they stay in the sky margins. Icon set lives in `lib/landing-floating-icons.ts`.
